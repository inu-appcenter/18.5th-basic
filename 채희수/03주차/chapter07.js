...
// shift와 unshift는 인덱스를 변경하는 사항이 있기 때문에 느리게 동작하게 됨
...
let arr5 = [1, 2, 3, 4, 5];
let sliced = arr5.slice(2, 5); // 2번무터 5번전까지 자름
let sliced2 = arr5.slice(2); // 2번부터 끝까지
let sliced3 = arr5.slice(-1); // 뒤에서 하나만 자름
console.log(sliced);
